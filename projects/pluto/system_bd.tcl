...
create_bd_port -dir I -from 13 -to 0 gpio_i
create_bd_port -dir O -from 13 -to 0 gpio_o
create_bd_port -dir O -from 13 -to 0 gpio_t
...
ad_ip_parameter sys_ps7 CONFIG.PCW_GPIO_EMIO_GPIO_IO 14
